    ...
    "
      >
        ...
        <NavLink
          ...
          to="/add-image"
        >
          <li className=" font-bold  mx-14 "> عکس </li>
        </NavLink>
        <NavLink
          style={{ webkitAppRegion: "no-drag" }}
          className={({ isActive }) => (isActive ? "text-red-700 " : "")}
          to="/news"
        >
          <li className=" font-bold "> اخبار </li>
        </NavLink>
        <NavLink
          style={{ webkitAppRegion: "no-drag" }}
          className={({ isActive }) => (isActive ? "text-red-700 " : "")}
        ...
        >
          <li className=" font-bold mx-14">درباره صرافی</li>
        </NavLink>
        <Link
          style={{ webkitAppRegion: "no-drag" }}
          onClick={() => window.reloadApp.reloadApplication()}
        >
          <li className=" font-bold hover:text-red-700">بارگذاری مجدد</li>
        </Link>
        ...
        <NavLink
          ...
          to="/close"
        >
          <li className={`hover:text-red-700 mr-14 `}>خروج</li>
        </NavLink>
      </ul>
    </div>
  );
